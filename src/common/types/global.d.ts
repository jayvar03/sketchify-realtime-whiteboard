...
export declare global {
  ...
  interface ServerToClientEvents {
    ...
    joined: (roomId: string, failed?: boolean, errorMessage?: string) => void;
    room: (room: Room, usersMoves: string, users: string) => void;
    ...
    canvas_cleared: (clearedByUsername: string, clearedByUserId: string) => void;
